...
library(tidyverse)
#library(purrr) 
# I think purrr is automatically loaded when tidyverse is loaded.
```
...
just_num <- function(df) {
  if(sum(map_lgl(df, is.numeric)) == 0) { 
    # Since purrr is loaded, you dont have to specify the package
