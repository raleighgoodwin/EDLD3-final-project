...
## To make the script cleaner and clearer, perhaps you can separate where the functions are defined and place where the functioned are calles. List the call function in a separate chunk at the end of the script. 
